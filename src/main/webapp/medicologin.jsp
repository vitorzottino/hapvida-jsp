...
<title>Hapvida Medico Login</title>
</head>
		...
		<div class="flex flex-col flex-1 items-center">
			<div
				...
				<img src="assets/logo-hapvida-escudo-2048.png" class="w-[40px]"
					alt="" srcset="">
				<h1 class="text-xl font-bold">Bem-vindo de volta!</h1>
				<p>Para se logar siga os passos abaixo:</p>
				<form class="items-center flex flex-col gap-8 p-2" method="post" action="login">
					<div>
